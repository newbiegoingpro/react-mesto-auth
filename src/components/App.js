...
function App() {
  ...
  return (
    <div className="App">
      <Header />
      <Main onEditProfile={handleEditProfileClick} onAddPlace={handleAddPlaceClick} onEditAvatar={handleEditAvatarClick} onDeleteCard={handleDeleteClick} onCardClick={handleCardClick}/>
      <Footer />
      <PopupWithForm title='Редактировать профиль' button='Сохранить' name='edit' isopen={isEditProfilePopupOpen} onClose={closeAllPopups}>
      ...
      <PopupWithForm title='Новое Место' button='Сохранить' name='add' isopen={isAddPlacePopupOpen} onClose={closeAllPopups}>
      ...
      <PopupWithForm title='Обновите Аватар' button='Сохранить' name='avatar' isopen={isEditAvatarPopupOpen} onClose={closeAllPopups}>
      ...
      <PopupWithForm title='Вы уверены?' button='Да' name='delete' isopen={isDeletePopupOpen} onClose={closeAllPopups}>
      </PopupWithForm>
